...
const UpdateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (+formBody.regularPrice < +formBody.discountedPrice)
  ...
  return (
    <main className='p-6 max-w-4xl mx-auto relative'>
      <FaArrowLeft
        ...
        className='absolute top-6 left-6 cursor-pointer text-2xl hover:text-orange-500 transition duration-300'
      />
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='grid grid-cols-2 gap-6'>
              ...
              <div className='flex flex-col'>
                ...
                <div className='flex flex-wrap gap-4'>
                  <label className='flex items-center gap-2'>
                    <input
                      checked={formBody.parking || false}
                      onChange={handleChange}
                      type='checkbox'
                      name='parking'
                      className='h-5 w-5 text-orange-500 focus:ring-orange-500'
                  ...
                  <label className='flex items-center gap-2'>
                    <input
                      onChange={handleChange}
                      checked={formBody.furnished || false}
                      type='checkbox'
                      name='furnished'
                      className='h-5 w-5 text-orange-500 focus:ring-orange-500'
                    />
            ...
            <div className='flex flex-col'>
              ...
              <input
                type='number'
                onChange={handleChange}
                value={formBody.regularPrice || 50}
                min='50'
                id='regularPrice'
                name='regularPrice'
                required
            ...
            {formBody.offer && (
              <div className='flex flex-col'>
                ...
                <input
                  type='number'
                  onChange={handleChange}
                  value={formBody.discountedPrice || 50}
                  min='50'
